...
<div class="mt-5">
    ...
    <div class="flex flex-wrap gap-3 mt-3">
        ...
        <button type="submit" name="action" value="advertisement" class="bg-gray-100 rounded border-2 border-gray-300 size-24 flex flex-col justify-center items-center text-sm bold text-gray-700">
