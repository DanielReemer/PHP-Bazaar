...
<div class="mt-5">
    ...
    <div class="flex flex-wrap gap-3">
        <button type="submit" name="action" value="text" class="bg-gray-100 rounded border-2 border-gray-300 size-24 flex flex-col justify-center items-center my-3 text-sm bold text-gray-700">
        ...
        <button class="bg-gray-100 rounded border-2 border-gray-300 size-24 flex flex-col justify-center items-center my-3 text-sm bold text-gray-700">
