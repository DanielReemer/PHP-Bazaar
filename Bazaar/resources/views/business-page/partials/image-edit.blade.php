<div class="flex">
    <div class="block w-3/4">
        ...
        <input type="file" id="{{ $component['type'] }}.url.{{ $component['id'] }}" name="{{ $component['type'] }}.url.{{ $component['id'] }}" value="{{ $component['arguments']->url }}" accept="image/png, image/gif, image/jpeg, image/jpg"  class="block w-3/4 text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400">
